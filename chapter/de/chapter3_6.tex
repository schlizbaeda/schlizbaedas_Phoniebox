...
\item{Überprüfen, ob das Softwareevent für den {\reader} ordnungsgemäß
      eingerichtet ist:\\
...
\filenam{/home/pi/RPi-Jukebox-RFID/scripts/deviceName.txt} geprüft
werden. Diese Datei enthält den oben gewählten Gerätenamen:\\

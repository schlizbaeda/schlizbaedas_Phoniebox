...
Abspielen von Musikdateien in den gängigen Audiocodecs wie mp3, Ogg
Vorbis, FLAC, AAC, Mod oder WAV. Clientsoftware kann den \software{mpd}
über dessen Protokoll sowohl lokal als auch über das Netzwerk steuern.
Damit ist er ideal für die Audiowiedergabe auf der {\Bezeichnung}
geeignet.\\
...
Rasp\-bian-Dis\-tri\-bu\-tion installierte \software{mpd} fehlerhaft:
...
\cmdPi{}\comment{Konfiguration des Quellcode-Projektes für den Kompilationsvorgang:}\\
...
--no-daemon /usr/bin/mpd --no-daemon \$MPDCONF} mit einem fehlerhaften

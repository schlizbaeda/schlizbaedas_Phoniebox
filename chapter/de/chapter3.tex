...
Für die Installation der Software müssen einige Konfigurationsdateien
...
%editieren, wie im diesem Kapitel beschrieben, können auch diese Vorlagen
%verwendet werden.
%\end{bclogo}
\begin{table}[h]
\centering
...
\hline
\filenam{rfid\_trigger\_play.conf}	&	In dieser Datei ist die Syntax erklärt	&	\\
\hline
...
\label{tab:cfgfiles}
\end{table}
\todo{Tabelle vervollständigen}TODO:

\input{chapter/\lang/chapter3_01}
\input{chapter/\lang/chapter3_02}
\input{chapter/\lang/chapter3_03}
\input{chapter/\lang/chapter3_04}
\input{chapter/\lang/chapter3_05}
\input{chapter/\lang/chapter3_06}
\input{chapter/\lang/chapter3_07}
\input{chapter/\lang/chapter3_08}
\input{chapter/\lang/chapter3_09}
\input{chapter/\lang/chapter3_10}
\input{chapter/\lang/chapter3_11}
\input{chapter/\lang/chapter3_12}
